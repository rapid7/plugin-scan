...
Devise.setup do |config|
  ...
  # added with devise 3.1.0
  secret_directory  = File.expand_path(File.join(File.dirname(__FILE__), ".."))
  secret_file       = File.join(secret_directory, "devise.key")
  ...
  config.secret_key = File.read(secret_file)
  ...
  # config.pepper = "5ecb95c102dd404e4cc0bac616470fdd4d0eb8527c1dba23e226a4a7d6ca42ffcbeeaaa0936dfd6261426ce2e2248aaf79b582eb86de796381a084c2c9a23077"
